...
#botoes
b_1 = Button(frame_corpo, command= limpar_tela, text="C" , width= 15, height=2, bg=cor4, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_1.place(x=0, y=0)
...
b_16 = Button(frame_corpo, command= lambda: entrar_valores('0'), text="0" , width= 15, height=2, bg=cor4, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
